package info.dgsoft.restful.unit.model.security;
...
public class CerberusUserTest {
  ...
  public void callingCerberusUserConstructorWithoutParametersCreatesExpectedObject() {
    SecurityUser cerberusUser = new SecurityUser();
  ...
  public void callingCerberusUserConstructorWithParametersCreatesExpectedObject() {
    SecurityUser cerberusUser = new SecurityUser(ID, USERNAME, PASSWORD, EMAIL, LAST_PASSWORD_RESET, AUTHORITIES);
