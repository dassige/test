...
@Entity
@Table(name = "services")
public class DGServiceEntity extends DomainBase
{
	...
	public DGServiceEntity()
	{
	}

	public DGServiceEntity(int id, String name, String url)
	{
		this.id = id;
		this.name = name;
		this.url = url;
	...
	public boolean equals(Object other)
	{
		...
		if (!(other instanceof DGServiceEntity)) return false;
		DGServiceEntity castOther = (DGServiceEntity) other;
